...
export function DrawerMenu({opened, close}: DrawerMenuProps) {
  ...
  return (
    <>
      <Drawer opened={opened}  size="14%" onClose={close} title="" withCloseButton={false}>
      <div className={' bg-blackBase fixed w-[100%] h-full  overflow-y-scroll overflow-hidden px-0 pr-1 hidden 1xl:block'}>
