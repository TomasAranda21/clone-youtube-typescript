...
const Header = ({searchCarousel} :props  )  => {
  ...
  return (
    ...
    <div className={'w-full flex flex-col sticky top-0 z-50 bg-blackBase'}>
      ...
      <div className={'w-full py-2 px-6 flex justify-between mx-auto items-center relative'}>
      ...
      <div className='py-6 w-[84%] px-5 h-[70px]
         overflow-x-hidden bg-blackBase absolute top-12 left-[14%]'>
        <CarouselSearch/>
      </div>
